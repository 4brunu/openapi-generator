...
public protocol PetAPI {
     ...
     */
    static func addPet(body: Pet, apiResponseQueue: DispatchQueue) -> Observable<Void>
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    static func deletePet(petId: Int64, apiKey: String, apiResponseQueue: DispatchQueue) -> Observable<Void>
     ...
     */
    static func findPetsByStatus(status: [String], apiResponseQueue: DispatchQueue) -> Observable<[Pet]>
    ...
    static func findPetsByTags(tags: [String], apiResponseQueue: DispatchQueue) -> Observable<[Pet]>
    ...
    /**
     ...
     - returns: Observable<Pet>
     */
    static func getPetById(petId: Int64, apiResponseQueue: DispatchQueue) -> Observable<Pet>
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    static func updatePet(body: Pet, apiResponseQueue: DispatchQueue) -> Observable<Void>
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    static func updatePetWithForm(petId: Int64, name: String, status: String, apiResponseQueue: DispatchQueue) -> Observable<Void>
     ...
     */
    static func uploadFile(petId: Int64, additionalMetadata: String, file: URL, apiResponseQueue: DispatchQueue) -> Observable<ApiResponse>
    ...
    /**
     ...
     - returns: Observable<ApiResponse>
     */
    static func uploadFileWithRequiredFile(petId: Int64, requiredFile: URL, additionalMetadata: String, apiResponseQueue: DispatchQueue) -> Observable<ApiResponse>
...
extension PetAPI {
    /**
     ...
     - returns: Observable<Void>
     */
    static func addPet(body: Pet, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Observable<Void> {
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    static func deletePet(petId: Int64, apiKey: String? = nil, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
    ...
    /**
     ...
     - returns: Observable<[Pet]>
     */
    static func findPetsByStatus(status: [String], apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Observable<[Pet]> {
        return Observable.create { observer -> Disposable in
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    static func findPetsByTags(tags: [String], apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Observable<[Pet]> {
        return Observable.create { observer -> Disposable in
    ...
    /**
     ...
     - returns: Observable<Pet>
     */
    static func getPetById(petId: Int64, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Observable<Pet> {
        return Observable.create { observer -> Disposable in
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    static func updatePet(body: Pet, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
    ...
    /**
     ...
     - returns: Observable<Void>
     */
    static func updatePetWithForm(petId: Int64, name: String? = nil, status: String? = nil, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Observable<Void> {
        return Observable.create { observer -> Disposable in
    ...
    /**
     ...
     - returns: Observable<ApiResponse>
     */
    static func uploadFile(petId: Int64, additionalMetadata: String? = nil, file: URL? = nil, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Observable<ApiResponse> {
        return Observable.create { observer -> Disposable in
    ...
    /**
     ...
     - returns: Observable<ApiResponse>
     */
    static func uploadFileWithRequiredFile(petId: Int64, requiredFile: URL, additionalMetadata: String? = nil, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Observable<ApiResponse> {
        return Observable.create { observer -> Disposable in
