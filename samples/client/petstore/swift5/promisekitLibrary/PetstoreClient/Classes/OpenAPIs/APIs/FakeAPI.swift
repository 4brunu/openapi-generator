...
public protocol FakeAPI {
     ...
     */
    static func fakeOuterBooleanSerialize( body: Bool, apiResponseQueue: DispatchQueue) -> Promise<Bool>
     ...
     */
    static func fakeOuterCompositeSerialize( body: OuterComposite, apiResponseQueue: DispatchQueue) -> Promise<OuterComposite>
     ...
     */
    static func fakeOuterNumberSerialize( body: Double, apiResponseQueue: DispatchQueue) -> Promise<Double>
     ...
     */
    static func fakeOuterStringSerialize( body: String, apiResponseQueue: DispatchQueue) -> Promise<String>
     ...
     */
    static func testBodyWithFileSchema( body: FileSchemaTestClass, apiResponseQueue: DispatchQueue) -> Promise<Void>
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    static func testBodyWithQueryParams( query: String,  body: User, apiResponseQueue: DispatchQueue) -> Promise<Void>
     ...
     */
    static func testClientModel( body: Client, apiResponseQueue: DispatchQueue) -> Promise<Client>
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    static func testEndpointParameters( number: Double,  double: Double,  patternWithoutDelimiter: String,  byte: Data,  integer: Int,  int32: Int,  int64: Int64,  float: Float,  string: String,  binary: URL,  date: Date,  dateTime: Date,  password: String,  callback: String, apiResponseQueue: DispatchQueue) -> Promise<Void>
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    static func testGroupParameters( requiredStringGroup: Int,  requiredBooleanGroup: Bool,  requiredInt64Group: Int64,  stringGroup: Int,  booleanGroup: Bool,  int64Group: Int64, apiResponseQueue: DispatchQueue) -> Promise<Void>
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    static func testInlineAdditionalProperties( param: [String: String], apiResponseQueue: DispatchQueue) -> Promise<Void>
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    static func testJsonFormData( param: String,  param2: String, apiResponseQueue: DispatchQueue) -> Promise<Void>
...
extension FakeAPI {
    /**
     ...
     - returns: Promise<Bool>
     */
    static func fakeOuterBooleanSerialize( body: Bool? = nil, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<Bool> {
    ...
    /**
     ...
     - returns: Promise<OuterComposite>
     */
    static func fakeOuterCompositeSerialize( body: OuterComposite? = nil, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<OuterComposite> {
    ...
    /**
     ...
     - returns: Promise<Double>
     */
    static func fakeOuterNumberSerialize( body: Double? = nil, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<Double> {
    ...
    /**
     ...
     - returns: Promise<String>
     */
    static func fakeOuterStringSerialize( body: String? = nil, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<String> {
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    static func testBodyWithFileSchema( body: FileSchemaTestClass, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<Void> {
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    static func testBodyWithQueryParams( query: String,  body: User, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
    ...
    /**
     ...
     - returns: Promise<Client>
     */
    static func testClientModel( body: Client, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<Client> {
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    static func testGroupParameters( requiredStringGroup: Int,  requiredBooleanGroup: Bool,  requiredInt64Group: Int64,  stringGroup: Int? = nil,  booleanGroup: Bool? = nil,  int64Group: Int64? = nil, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    static func testInlineAdditionalProperties( param: [String: String], apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    static func testJsonFormData( param: String,  param2: String, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
