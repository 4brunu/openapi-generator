...
public protocol StoreAPI {
     ...
     */
    static func deleteOrder( orderId: String, apiResponseQueue: DispatchQueue) -> Promise<Void>
     ...
     */
    static func getInventory(apiResponseQueue: DispatchQueue) -> Promise<[String: Int]>
     ...
     */
    static func getOrderById( orderId: Int64, apiResponseQueue: DispatchQueue) -> Promise<Order>
    ...
    /**
     ...
     - returns: Promise<Order>
     */
    static func placeOrder( body: Order, apiResponseQueue: DispatchQueue) -> Promise<Order>
...
extension StoreAPI {
    /**
     ...
     - returns: Promise<Void>
     */
    static func deleteOrder( orderId: String, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<Void> {
    ...
    /**
     ...
     - returns: Promise<[String: Int]>
     */
    static func getInventory(apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<[String: Int]> {
    ...
    /**
     ...
     - returns: Promise<Order>
     */
    static func getOrderById( orderId: Int64, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<Order> {
    ...
    /**
     ...
     - returns: Promise<Order>
     */
    static func placeOrder( body: Order, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Promise<Order> {
        let deferred = Promise<Order>.pending()
