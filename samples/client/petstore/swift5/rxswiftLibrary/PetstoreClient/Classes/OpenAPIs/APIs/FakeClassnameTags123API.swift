...
protocol FakeClassnameTags123API {
     ...
     */
    static func testClassname(body: Client, apiResponseQueue: DispatchQueue) -> Observable<Client>
...
extension FakeClassnameTags123API {
    /**
     ...
     - returns: Observable<Client>
     */
    static func testClassname(body: Client, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue) -> Observable<Client> {
