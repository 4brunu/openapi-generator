...
public protocol FakeAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    static func testEndpointParameters(integer: Int?, int32: Int?, int64: Int64?, number: Double, float: Float?, double: Double, string: String?, patternWithoutDelimiter: String, byte: Data, binary: URL?, date: Date?, dateTime: Date?, password: String?, callback: String?, apiResponseQueue: DispatchQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void))
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    static func testEndpointParametersWithRequestBuilder(integer: Int, int32: Int, int64: Int64, number: Double, float: Float, double: Double, string: String, patternWithoutDelimiter: String, byte: Data, binary: URL, date: Date, dateTime: Date, password: String, callback: String) -> RequestBuilder<Void>
    /**
...
extension FakeAPI {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    static func testEndpointParametersWithRequestBuilder(integer: Int? = nil, int32: Int? = nil, int64: Int64? = nil, number: Double, float: Float? = nil, double: Double, string: String? = nil, patternWithoutDelimiter: String, byte: Data, binary: URL? = nil, date: Date? = nil, dateTime: Date? = nil, password: String? = nil, callback: String? = nil) -> RequestBuilder<Void> {
        let path = "/fake"
        let URLString = PetstoreClient.basePath + path
