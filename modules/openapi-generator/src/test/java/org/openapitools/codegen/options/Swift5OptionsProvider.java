...
public class Swift5OptionsProvider implements OptionsProvider {
    ...
    public static final String SWIFT_USE_MODEL_NAMESPACE_VALUE = "swiftUseModelNamespace";
    ...
    public Map<String, String> createOptions() {
        ...
        return builder.put(CodegenConstants.SORT_PARAMS_BY_REQUIRED_FLAG, SORT_PARAMS_VALUE)
                ...
                .put(Swift5ClientCodegen.SWIFT_USE_MODEL_NAMESPACE, SWIFT_USE_MODEL_NAMESPACE_VALUE)
