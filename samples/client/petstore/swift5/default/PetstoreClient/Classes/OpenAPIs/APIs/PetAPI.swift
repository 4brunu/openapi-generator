...
protocol PetAPI {
    ...
    static func findPetsByTags(tags: Set<String>, apiResponseQueue: DispatchQueue, completion: @escaping ((_ data: Set<Pet>?, _ error: Error?) -> Void))
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    static func findPetsByTagsWithRequestBuilder(tags: Set<String>) -> RequestBuilder<Set<Pet>>
    /**
     Find pet by ID
...
extension PetAPI {
     ...
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    static func findPetsByTags(tags: Set<String>, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue, completion: @escaping ((_ data: Set<Pet>?, _ error: Error?) -> Void)) {
