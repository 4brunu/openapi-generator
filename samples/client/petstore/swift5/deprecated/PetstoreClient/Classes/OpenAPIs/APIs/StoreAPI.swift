...
public protocol StoreAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    static func placeOrder(order: Order, apiResponseQueue: DispatchQueue, completion: @escaping ((_ data: Order?, _ error: Error?) -> Void))
    ...
    /**
     ...
     - returns: RequestBuilder<Order> 
     */
    static func placeOrderWithRequestBuilder(order: Order) -> RequestBuilder<Order>
}
...
extension StoreAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    static func placeOrder(order: Order, apiResponseQueue: DispatchQueue = PetstoreClient.apiResponseQueue, completion: @escaping ((_ data: Order?, _ error: Error?) -> Void)) {
